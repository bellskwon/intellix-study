...
const navItems = [
  ...
  { path: '/storage', label: 'Storage', icon: Archive, color: 'text-green-500' },
  { path: '/friends', label: 'Social', icon: Users, color: 'text-blue-500' },
  { path: '/progress', label: 'Progress', icon: TrendingUp, color: 'text-red-500' },
